...
var ProductDetail = (function () {
    function ProductDetail(route, router, productService) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.productService = productService;
        this.pageTitle = "Product Details";
        var id = route.params.forEach(function (params) {
            _this.pageTitle += " For id " + params['id'];
        });
    }
    ...
    ProductDetail.prototype.ngOnDestroy = function () {
    };
    ProductDetail.prototype.getProduct = function (id) {
        var _this = this;
